...
let Positions = {
	playerInitial: {x: Const.TILE_SIZE * 113, y: Const.GROUND - Const.TILE_SIZE * 5 },
	...
	flyRegion: {x1: 115 * Const.TILE_SIZE, x2: 116 * Const.TILE_SIZE, y1: Const.GROUND - 20 * Const.TILE_SIZE}
}
